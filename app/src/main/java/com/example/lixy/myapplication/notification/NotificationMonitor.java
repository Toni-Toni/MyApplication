...
public class NotificationMonitor extends NotificationListenerService {
	...
	private static final String NOTIFICATION_QQ = "com.tencent.mobileqq";
	private static final String NOTIFICATION_WEIXIN = "com.tencent.mobileqq";
	private static final String NOTIFICATION_SMS = "com.tencent.mobileqq";
	...
	public void onNotificationPosted(StatusBarNotification sbn) {
		updateCurrentNotifications();
		logNLS("onNotificationPosted..." + sbn.getPackageName());
		...
		Icon notificationLargeIcon = sbn.getNotification().getLargeIcon();
		Icon notificationSmallIcon = sbn.getNotification().getSmallIcon();
